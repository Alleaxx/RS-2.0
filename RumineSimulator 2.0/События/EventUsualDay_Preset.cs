...
namespace RumineSimulator_2._0
{
    static class EventUsualDay_Preset
    {
        ...
        //{
        //    //Создание события
        //    Event adminCome = new MediumEvent($"Админ в онлайне", EventType.adminCome);
        //    User MadMoss = UsersControl.UserSearch("MadMoss");
        //    User south_park = UsersControl.UserSearch("south_park");
        //    //Кто зашел
        //    if (AdvRnd.PrsChanse(65))
        //    {
        //        adminCome.EventAdd1_BasicInfo(MadMoss);
        //    }
        //    else
        //    {
        //        adminCome.EventAdd1_BasicInfo(south_park);
        //    }
        //    //adminCome.Name = $"{adminCome.Creator.nick} в онлайне";
        //    adminCome.participants.Add(UsersControl.UserSearch(adminCome.Creator.nick), "Зашедший админ");

        //    #region Важность события

        //    if (AdvRnd.PrsChanse(20))
        //        adminCome.Rareness = EventImportance.usual;
        //    else if (AdvRnd.PrsChanse(92))
        //        adminCome.Rareness = EventImportance.rare;
        //    else
        //        adminCome.Rareness = EventImportance.epic;

        //    #endregion

        //    //Воплощение события
        //    int admin_effect = 0;
        //    UsersControl.UserSearch(adminCome.Creator.nick).last_activity = Date.current_date;
        //    //Обычный заход, ничего интересного, 80%
        //    if (AdvRnd.PrsChanse(80))
        //    {
        //        adminCome.AddMods(5, 1, 0, 0);
        //        admin_effect = 1;
        //    }
        //    //Админ что-то комментирует, слегка интереснее, небольшой шанс обещания новой группы, 20%
        //    else
        //    {
        //        adminCome.AddMods(10, 2, 0, 0);
        //        UsersControl.UserSearch(adminCome.Creator.nick).comments++;
        //        admin_effect = 2;
        ...
        //    {
        //        adminCome.Rareness = EventImportance.historical;
        //        UsersControl.UserSearch(adminCome.Creator.nick).messages += AdvRnd.random.Next(10);
        //        UsersControl.UserSearch(adminCome.Creator.nick).likes += AdvRnd.random.Next(30);
        //        adminCome.AddMods(30, 10, 5, 1);
        //        admin_effect = 4;
        ...
        //    {
        //        //case 1:
        //        //    adminCome.EventAdd7_Description($"В онлайн зашел {adminCome.Creator.nick}. При этом не произошло ничего особо интересного");
        //        //    adminCome.EventAdd7_Description($"{adminCome.Creator.nick} был замечен {adminCome.date}. Судя по всему, он переносил новости на главную и читал ЛС");
        //        //    break;
        //        //case 2:
        //        //    adminCome.EventAdd7_Description($"{adminCome.date} на сайт зашел {adminCome.Creator.nick}, откомментировав парочку новостей. Это дало надежду на то, что админов удастстя разговорить, однако ничего не вышло");
        //        //    adminCome.EventAdd7_Description($"Редкий случай произошел {adminCome.date} - {adminCome.Creator.nick} находился в онлайне подозрительно долго. Что он при этом делал - неясно. Пользователи активно обсуждают это во флудилке");
        //        //    break;
        //        //case 4:
        //        //    adminCome.EventAdd7_Description($"Невероятно! Никто не ожидал этого, однако {adminCome.date} на сайт зашел {adminCome.Creator.nick} и написал в ФЧ несколько постов! Это вызвало небывалой ажиотаж у юзеров, ибо каждый считал своим долгом расспросить его о всяком разном. Народ надолго запомнит этот день");
        //        //    adminCome.EventAdd7_Description($"Редчайшее явление - {adminCome.date} появился в ФЧ {adminCome.Creator.nick}! Такое счастье выпадает нечасто. Пользователи весьма продуктивно пообщались с ним во флудилке");
        //        //    break;


        //    }
        //    #endregion
        //    //adminCome.EventSetDescription(event_descr);
        //    return adminCome;
        //}
        ////Большая дискуссия
        ...
        //{
        //    //Создание события
        //    Event bigDisskusion = new MediumEvent($"Большая дискуссия", EventType.bigDiskussion);
        //    bigDisskusion.EventAdd1_BasicInfo(rnd_User);
        //    bigDisskusion.participants.Add(rnd_User, "Создатель обсуждения");

        //    #region Важность события

        //    if (AdvRnd.PrsChanse(10))
        //        bigDisskusion.Rareness = EventImportance.usual;
        //    else if (AdvRnd.PrsChanse(90))
        //        bigDisskusion.Rareness = EventImportance.rare;
        //    else
        //        bigDisskusion.Rareness = EventImportance.epic;
        ...
        //    bigDisskusion.AddMods(bigDisskusion.participants.Count * 3, bigDisskusion.participants.Count, 0, 0);
        ...
        //        }
        //    }
        //    Event leaveUser = new MediumEvent($"Уход {rnd_User.nick}", EventType.userLeave);
        //    #region Важность события

        //    if (AdvRnd.PrsChanse(10))
        //        leaveUser.Rareness = EventImportance.usual;
        //    else if (AdvRnd.PrsChanse(30))
        //        leaveUser.Rareness = EventImportance.rare;
        //    else
        //        leaveUser.Rareness = EventImportance.epic;

        //    #endregion
        //    leaveUser.EventAdd1_BasicInfo(rnd_User);
        ...
        //        infl += 5;
        //    }
        //    leaveUser.AddMods(infl, infl / 2, 0, 0);
        ...
        //    //Создание события
        //    Event leaveUser = new MediumEvent($"{rnd_User.nick} вернулся!", EventType.userCome);
        //    #region Важность события
        ...
        //{
        //    Event dayEnd = new MediumEvent($"Отчет за {Date.current_date_prev.ToShortDateString()}", EventType.dayEnd);
        //    dayEnd.Rareness = EventImportance.rare;
        //    dayEnd.AddMods(AdvRnd.random.Next(0), 0, 0, 0);
