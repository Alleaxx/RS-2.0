...
namespace RumineSimulator_2._0
{
    class Interface_User : InterfaceView
    {
        ...
        public Interface_User(User user) : base()
        {
            ...
            try
            {
                interface_basic.AddImage(Nicks.AvaPath[user.nick].ToString());
            }
            catch
            {
                interface_basic.AddImage("No_ava.png");
            }
            //Даты
            basic_properties.Add(new Interface_String("Группа: ", user.group.Name, true, StringProfile.Header));
            basic_properties.Last().AddColor("", "",user.group.ColorHTML);
            basic_properties.Last().SetSize(18, 14);
            basic_properties.Last().AddToolTip($"Права журналиста {user.group.Journ}" +
            ...
            basic_properties.Add(new Interface_String("Даты", "", false, StringProfile.Header));
            basic_properties.Last().SetSize(18, 14);
            ...
            {
                basic_properties.Add(new Interface_String("Фракции", "", false, StringProfile.Header));
            ...
            basic_properties.Add(new Interface_String("Дополнительно", "", false, StringProfile.Header));
            basic_properties.Last().SetSize(18, 14);
            ...
            //Трейты
            traits.Add(new Interface_String("Черты характера", $"({user.traits.Count})", false, StringProfile.Header));
            traits.Add(new Interface_String("Фактические", "", false, StringProfile.Header));
            ...
            traits.Add(new Interface_String("Персональные", "", false, StringProfile.Header));
            traits.Last().SetSize(18, 14);
            foreach (Trait trait in user.traits)
            {
                if (trait.type == TraitType.character)
            ...
            numeric_properties.Add(new Interface_String("Статистика сайта", "", false, StringProfile.Header));
            ...
            numeric_properties.Add(new Interface_String("Форум", "", false, StringProfile.Header));
            numeric_properties.Last().SetSize(18, 14);
            ...
            numeric_properties.Add(new Interface_String("Карма", user.karma.karma.ToString(), false, StringProfile.Header));
            numeric_properties.Last().SetSize(18, 14);
